...
public class ProfileTonnageTest extends basetest{
	...
	public void ton(String user,String pass,String customer,String generator) {
		...
		lo.login(user, pass);
		ProfileTonnagePage ptp = new ProfileTonnagePage(getPage());
		ptp.Tonnage();
		CommonDropdown cp = new CommonDropdown();
		cp.selectFromDropdown(getPage(), PageLocators.Facility_Arrow, PageLocators.FACILITY_LIST, "2138 - Petro-Chem Processing Group (ESOL) - 421 Lycaste, Detroit, MI 48214 - 2138");
		cp.selectFromDropdown(getPage(), PageLocators.Facility_Arrow1, PageLocators.Facility_LIST1, "2138 - Petro-Chem Processing Group (ESOL)");
		ptp.cstmr(customer);
		ptp.genertr(generator);
		DatePickerUtils.previousselectDate(getPage(), "//a[@id = 'ctl00_MainContent_rdpStartDate_popupButton']","//span[contains(@id,'StartDate_calendar_Title')]","//a[@id= 'ctl00_MainContent_rdpStartDate_calendar_NP']", "//div[contains(@id,'ctl00_MainContent_rdpStartDate_calendar')]//td[@title='Tuesday, July 01, 2025']/a","July 2025","01");
